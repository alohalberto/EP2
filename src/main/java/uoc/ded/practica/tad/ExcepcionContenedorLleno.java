package uoc.ei.tads;
/**
 * Clase que implementa la excepción que se genera cuando se quiere insertar un
 * elemento en un contenedor (acotado) que está lleno.
 *
 ...
 * @version 2.0.0
 */
public class ExcepcionContenedorLleno  extends ExcepcionTADs
{
   ...
   public ExcepcionContenedorLleno() { super(); }

   /**
    * Constructor con un parámetro.
    * @param mensaje  mensaje con el error que ha generado la excepción
    */
   public ExcepcionContenedorLleno(String mensaje) { super(mensaje); }
}
